$(document).ready(function () {
    ...
    var cityUrl = "http://localhost/RandomCountryChromeExtension/RESTAPI/alt.php/city";
    var countryUrl = "http://localhost/RandomCountryChromeExtension/RESTAPI/alt.php/country";
